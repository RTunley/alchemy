import flask
from flask import g
from alchemy import db, models, auth_manager, score_manager, summary_profiles, file_input, file_output, reports
import os
...
def paper_report(paper_id=0):
    paper = models.Paper.query.get_or_404(paper_id)
    paper.paper_questions = sorted(paper.paper_questions, key=lambda x: x.order_number)
    clazz_report = reports.ClazzPaperReport(g.clazz, paper)
